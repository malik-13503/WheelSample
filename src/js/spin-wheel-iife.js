...
var spinWheel = (() => {
  ...
  var C = Math.pow,
    M = (s, e, t) =>
      e in s
        ...
        : (s[e] = t),
    R = (s, e) => {
      for (var t in e || (e = {})) I.call(e, t) && M(s, t, e[t]);
      if (y) for (var t of y(e)) H.call(e, t) && M(s, t, e[t]);
      return s;
    };
  var X = (s, e) => {
      for (var t in e) p(s, t, { get: e[t], enumerable: !0 });
    },
    Y = (s, e, t, i) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let r of j(e))
          !I.call(s, r) &&
            ...
            p(s, r, {
              get: () => e[r],
              enumerable: !(i = N(e, r)) || i.enumerable,
            });
      return s;
    };
  var q = (s) => Y(p({}, "__esModule", { value: !0 }), s);
  var Z = {};
  X(Z, { Wheel: () => w });
  function x(s = 0, e = 0, t = 14) {
    return parseFloat((Math.random() * (e - s) + s).toFixed(t));
  }
  function m(s = 0) {
    return (s * Math.PI) / 180;
  }
  function E(s, e, t) {
    return e < t ? e <= s && s < t : e <= s || s < t;
  }
  function W(s, e, t, i) {
    i.save(), (i.font = `1px ${e}`);
    let r = i.measureText(s).width;
    return i.restore(), t / r;
  }
  function A(s = { x: 0, y: 0 }, e, t, i) {
    return C(s.x - e, 2) + C(s.y - t, 2) <= C(i, 2);
  }
  function L(s = { x: 0, y: 0 }, e = {}, t = 1) {
    let i = e.getBoundingClientRect();
    return { x: (s.x - i.left) * t, y: (s.y - i.top) * t };
  }
  function T(s, e, t, i) {
    let r = s - t,
      n = e - i,
  ...
  function $(s = 0, e = 0) {
    let t = s + e,
      i;
    return (
      t > 0 ? (i = t % 360) : (i = 360 + (t % 360)), i === 360 && (i = 0), i
    );
  }
  function P(s = 0, e = 0) {
    let t = 180 - e;
  ...
  function k(s = 0, e = 0, t = 1) {
    let i = ((s % 360) + e) % 360;
    return (
      (i = U(i)), (i = (t === 1 ? 360 - i : 360 + i) % 360), (i *= t), s + i
    );
  }
  function c(s) {
  ...
  function v(s) {
    return s && s.complete && s.naturalWidth !== 0 && s.naturalHeight !== 0;
  }
  function U(s = 0) {
  ...
  var J = Object.freeze({ left: "left", right: "right", center: "center" }),
    o = Object.freeze({
      wheel: {
        borderColor: "#000",
        borderWidth: 1,
  ...
  function F(s = {}) {
    K(s),
      (s._handler_onResize = (t) => s.resize(t)),
      window.addEventListener("resize", s._handler_onResize);
    let e = () => {
      s.resize(),
        matchMedia(`(resolution: ${pr}dppx)`).addEventListener("change", e, {
          once: !0,
        });
    };
  }
  function D(s = {}) {
    ...
    "PointerEvent" in window
      ? (e.removeEventListener("pointerdown", s._handler_onPointerDown),
        e.removeEventListener(
          "pointermove",
          s._handler_onPointerMoveRefreshCursor
        ))
      : (e.removeEventListener("touchstart", s._handler_onTouchStart),
        e.removeEventListener("mousedown", s._handler_onMouseDown),
        e.removeEventListener(
          "mousemove",
          s._handler_onMouseMoveRefreshCursor
        )),
      window.removeEventListener("resize", s._handler_onResize);
  }
  function K(s = {}) {
    let e = s.canvas;
    (s._handler_onPointerMoveRefreshCursor = (t = {}) => {
      let i = { x: t.clientX, y: t.clientY };
      (s.isCursorOverWheel = s.wheelHitTest(i)), s.refreshCursor();
    }),
      (s._handler_onMouseMoveRefreshCursor = (t = {}) => {
        let i = { x: t.clientX, y: t.clientY };
        (s.isCursorOverWheel = s.wheelHitTest(i)), s.refreshCursor();
      }),
      (s._handler_onPointerDown = (t = {}) => {
        let i = { x: t.clientX, y: t.clientY };
        if (!s.isInteractive || !s.wheelHitTest(i)) return;
        t.preventDefault(),
          s.dragStart(i),
        ...
        function r(a = {}) {
          a.preventDefault(), s.dragMove({ x: a.clientX, y: a.clientY });
        }
        function n(a = {}) {
          a.preventDefault(),
      ...
      "PointerEvent" in window
        ? (e.addEventListener("pointerdown", s._handler_onPointerDown),
          e.addEventListener(
            "pointermove",
            s._handler_onPointerMoveRefreshCursor
          ))
        : (e.addEventListener("touchstart", s._handler_onTouchStart),
          e.addEventListener("mousedown", s._handler_onMouseDown),
          e.addEventListener("mousemove", s._handler_onMouseMoveRefreshCursor));
  }
  var S = class {
    constructor(e, t = {}) {
      ...
      this._wheel = e;
      for (let i of Object.keys(o.item)) this["_" + i] = o.item[i];
    ...
    set image(e) {
      ...
      typeof e == "string"
        ? ((t = new Image()),
          (t.src = e),
          (t.onload = (i) => this._wheel.refresh()))
        : (t = o.item.image),
        (this._image = t),
        this._wheel.refresh();
    }
  ...
  var w = class {
    constructor(e, t = {}) {
      ...
      (this._frameRequestId = null),
        ...
        this.add(e);
      for (let i of Object.keys(o.wheel)) this["_" + i] = o.wheel[i];
    ...
    resize() {
      let [e, t] = [
        ...
        i = Math.min(e, t),
        r = { w: i - i * this.offset.w, h: i - i * this.offset.h },
    ...
    draw(e = 0) {
      ...
      this.drawItemBackgrounds(t, i),
        this.drawItemImages(t, i),
        this.drawItemLines(t, i),
        this.drawItemLabels(t, i),
        this.drawBorder(t),
    ...
    drawImage(e, t, i = !1) {
      ...
      e.translate(this._center.x, this._center.y),
        i || e.rotate(m(this._rotation));
      let r = i ? this._size : this._size * this.radius,
        n = -(r / 2);
    ...
    drawItemLabels(e, t = []) {
      let i = this.itemLabelFontSize * -this.itemLabelBaselineOffset,
      ...
      for (let [a, h] of t.entries()) {
        ...
        e.translate(
          ...
          this._itemLabelStrokeWidth > 0 &&
            ...
            (e.lineJoin = "round"),
            e.strokeText(d.label, 0, i)),
          (e.fillStyle = _),
          e.fillText(d.label, 0, i),
          e.restore();
      }
    }
    drawDragEvents(e) {
    ...
    animateRotation(e = 0) {
      if (this._spinToTimeEnd !== null) {
        ...
        (this.rotation =
          this._spinToStartRotation + r * this._spinToEasingFunction(i)),
          this.refresh();
        return;
      }
    ...
    spinToItem(e = 0, t = 0, i = !0, r = 1, n = 1, a = null) {
    ...
    animate(e, t, i) {
      (this._spinToStartRotation = this.rotation),
        ...
        (this._spinToEasingFunction = i || V),
        this.refresh();
    }
    stop() {
      (this._spinToTimeEnd = null),
    ...
    getAngleFromCenter(e = { x: 0, y: 0 }) {
      return (T(this._center.x, this._center.y, e.x, e.y) + 90) % 360;
    }
    getCurrentIndex() {
    ...
    refreshCurrentIndex(e = []) {
      ...
      for (let [t, i] of e.entries())
        if (!!E(this._pointerAngle, i.start % 360, i.end % 360)) {
    ...
    getItemAngles(e = 0) {
      ...
      for (let h of this._items)
        (r = h.weight * i), a.push({ start: n, end: n + r }), (n += r);
      return (
    ...
    set image(e) {
      (this._image = l({
        ...
        action: () => {
          ...
          let t = new Image();
          return (t.src = e), (t.onload = (i) => this.refresh()), t;
        },
      })),
        this.refresh();
    }
    ...
    dragEnd() {
      ...
      let e = 0,
        t = performance.now();
      for (let [i, r] of this.dragEvents.entries()) {
        if (!this.isDragEventTooOld(t, r)) {
          e += r.distance;
          continue;
        }
        (this.dragEvents.length = i), this.debug && this.refresh();
        break;
      }
      this.refreshCursor(),
